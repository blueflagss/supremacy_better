...
bool CSGO::Init( ) {
	...
	cl_sidespeed = m_cvar->FindVar( HASH( "cl_sidespeed" ) );
	cam_ideallag = m_cvar->FindVar( HASH( "cam_ideallag" ) );
	...
	// functions.
	tier0_allocated_thread_ids = Address( reinterpret_cast< std::uint8_t* >( reinterpret_cast< std::uintptr_t >( GetModuleHandleA( "tier0.dll" ) ) + 0x51AA0 ) );
