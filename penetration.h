...
namespace penetration {
	...
	float scale_dmg_new ( Player *player, float damage, float armor_ratio, int hitgroup, bool is_zeus );
	bool TraceRay( const vec3_t& min, const vec3_t& max, const BoneArray& mat, float r, const vec3_t& src, const vec3_t& dst );
